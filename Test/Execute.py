...
Quantities = {
        ...
        'adj' : np.zeros((Time, len(all_atoms), len(all_atoms))), 'pdf' : np.zeros((Time, 2, 300)),
...
for i in range(Start, End, Step):
    ...
    T1=time.time()
    if i%100 == 0:
        print(i, "Step took ", T1-T0, " seconds.")
...
with open("CuMeta.csv", "wb") as write:
